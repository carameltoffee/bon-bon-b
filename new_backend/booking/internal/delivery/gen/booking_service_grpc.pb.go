...
type BookingServiceClient interface {
	...
	GetBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*BookingResponse, error)
	UpdateBooking(ctx context.Context, in *UpdateBookingRequest, opts ...grpc.CallOption) (*BookingResponse, error)
	DeleteBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*Empty, error)
	ListBookings(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*BookingListResponse, error)
}
...
func (c *bookingServiceClient) GetBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*BookingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BookingResponse)
...
func (c *bookingServiceClient) DeleteBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *bookingServiceClient) ListBookings(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*BookingListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BookingServiceServer interface {
	...
	GetBooking(context.Context, *BookingIdRequest) (*BookingResponse, error)
	UpdateBooking(context.Context, *UpdateBookingRequest) (*BookingResponse, error)
	DeleteBooking(context.Context, *BookingIdRequest) (*Empty, error)
	ListBookings(context.Context, *UserIdRequest) (*BookingListResponse, error)
...
func (UnimplementedBookingServiceServer) GetBooking(context.Context, *BookingIdRequest) (*BookingResponse, error) {
...
func (UnimplementedBookingServiceServer) DeleteBooking(context.Context, *BookingIdRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBooking not implemented")
}
func (UnimplementedBookingServiceServer) ListBookings(context.Context, *UserIdRequest) (*BookingListResponse, error) {
...
func _BookingService_GetBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetBooking(ctx, req.(*BookingIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookingService_DeleteBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).DeleteBooking(ctx, req.(*BookingIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookingService_ListBookings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).ListBookings(ctx, req.(*UserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
